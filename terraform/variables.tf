...
variable "s3_skip_credentials_validation" {
  description = "Skip S3 credentials validation"
  type        = bool
  default     = false
}

variable "s3_skip_metadata_api_check" {
  description = "Skip S3 metadata API check"
  type        = bool
  default     = false
}

variable "s3_skip_region_validation" {
  description = "Skip S3 region validation"
  type        = bool
  default     = false
}

variable "s3_force_path_style" {
  description = "Force path-style addressing for S3"
  type        = bool
  default     = false
}

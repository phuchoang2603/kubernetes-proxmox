...
# Note: OIDC configuration is now managed in terraform-admin via Vault OIDC provider
# The OIDC issuer URL and client ID will be provided via GitHub Actions variables
